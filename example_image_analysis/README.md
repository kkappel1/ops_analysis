...
## <ins>**Set up**</ins>: 
1. Copy this directory to a location where you want to run the analysis. Then within the directory, download the required raw data from zenodo ([https://doi.org/10.5281/zenodo.15538926](https://doi.org/10.5281/zenodo.15538926)), and unzip it. You should have two directories within the `example_data_analysis` directory: `raw_SBS_images` and `raw_phenotype_images`.
